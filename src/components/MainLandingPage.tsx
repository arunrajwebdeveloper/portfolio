...
function MainLandingPage({ baseVelocity }: MainLandingPageProps) {
  ...
  return (
    ...
    >
      <div className="flex-col md:flex-row w-full h-full absolute inset-0 flex items-center justify-between">
        <div
          style={{
            backgroundImage: 'url("./sand-bg.jpg")',
          }}
          className="w-full md:w-1/2 h-full overflow-hidden bg-center bg-no-repeat bg-cover"
        ></div>
        <div
          style={{
